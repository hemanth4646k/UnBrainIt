        ...
        <div className="h-screen w-screen bg-white flex justify-center pt-15">
            <div className="bg-white shadow-md rounded-xl w-[500px] m-2 pt-15 h-2/3 flex flex-col items-center">
                ...
                <div className="flex justify-center m-4 pt-2 items-center">
                    <Button extraClass="shadow-lg border border-violet-400 shadow-violet-300" fullwidth={true} onclick={()=>handleSignup()} variant="secondary" text="Signup" size="lg"></Button>

                </div>
                <div className="flex justify-between flex-wrap p-2">Have an account?
                    <span className="p-2"></span>
                    <a href="/signin" className="text-blue-600">SignUp</a>
               </div>
            </div>
        </div>
    )
